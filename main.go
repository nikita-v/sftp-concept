...
func main() {
	...
	for {
		...
		go handleConnection(clientConn, config, debugStream)
	}
}

func handleConnection(connection net.Conn, config *ssh.ServerConfig, debugStream io.Writer) {
